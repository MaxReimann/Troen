...
namespace troen
{
	namespace input
	{
		/*! The AIPy class writes the calculated values from the artificial intelligence into the BikeInputState.*/
		class AIPy : public omega::ReferenceType, public PollingDevice
		{
		public:
			AIPy(osg::ref_ptr<BikeInputState> bikeInputState, troen::BikeController* bikeController);
